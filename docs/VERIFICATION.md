...
Current expected result for v0.2.4:
...
identifier/CSV/RIS/BibTeX ingest and deterministic handoff export: OK
schema v1-to-v2 migration and per-record ingest audit: OK
```
